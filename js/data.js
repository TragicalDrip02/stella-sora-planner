...
// (1) Material image paths
window.MATERIAL_IMAGE_PATHS = {
...
// (4) Ascension, skills, bosses, and tables
window.characterAscensionMaterials = {
...
window.characterDiscAscensionMaterials = {};

window.characterSkillCartridges = {
...
/* Build full characters list */
window.buildCharacterWithTiers = function (ch) {
...
window.characters = manifestCharacters.map(buildCharacterWithTiers);
